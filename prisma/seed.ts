...
//função que usará o 'PrismaClient' p passar comandos e instruções p limpeza e posterior criação dos prompts padrão do projeto
async function main() {
  await prisma.prompt.deleteMany()


    //criando prompt de título
...
//chamando a como promise a função criada q engloba os 2 prompts
main()
  .then(async () => {
